...
/*
 * Factory 클래스는 프로젝트 전체에서 사용할 어떤 정보, 도구를 만들어서 배포하는 클래스를 말한다.
 * 
 * Java에서 JDBC를 사용해서 데이터 연결, 작업을 할 수 있는데
 * Factory를 사용해서 DB에 연결작업을 수행하면 다양한 방법으로 DB에 연결할 수 있다.
 */
